...
## Project Structure
    ...
    ├── dry_union_dev_116279  # Django project configurations
...
1. Clone this repo and `cd dry_union_dev_116279`
...
2. Clone this repo and `cd dry_union_dev_116279`
